...
public class ProyFinal_Sistema_Solar_2 extends SimpleApplication 
{

    public static void main(String[] args) 
    {
        ProyFinal_Sistema_Solar_2 app = new ProyFinal_Sistema_Solar_2();
        app.start();
    }
    ...
    Vector3f camera = new Vector3f(0f, 0f, 30f);
    ...
    public void simpleInitApp() 
    {
        ...
        Sphere venus = new Sphere(30, 30, 0.9f);
        Geometry geomVenus = new Geometry("Venus", venus);
        
        Sphere tierra = new Sphere(30, 30, 0.9f);
        Geometry geomTierra = new Geometry("Tierra", tierra);
        
        Sphere luna = new Sphere(30, 30, 0.4f);
        ...
        geomLuna.setLocalTranslation(1.5f, 0f, 0f);
        ...
        nodeVenus.setLocalTranslation(6f, 0, 0f);
        nodeTierra.setLocalTranslation(9f, 0, 0f);
    ...
    public void simpleUpdate(float tpf) 
    {
        ...
        **/
        ...
        rootNode.getChild("nodo_tierra").rotate(tpf, tpf, tpf);
        ...
        rootNode.getChild("pivote_venus").rotate(0, tpf/2, tpf/2);
        
        //Velocidad del planeta Tierra alrededor del Sol
        rootNode.getChild("pivote_tierra").rotate(0, tpf/3, tpf/3);
    }
